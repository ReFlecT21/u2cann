...
interface DeclineExpertTemplateProps {
  greeting: string;
  projectName: string;
}

export const DeclineExpertTemplate: React.FC<
  Readonly<DeclineExpertTemplateProps>
      ...
      <Container style={container}>
        ...
        <Section style={content}>
          ...
          <Text style={paragraph}>
            Thank you for applying to the project opportunity on AsiaDealHub. We
            appreciate the time and effort you took to submit your application.
          </Text>
          ...
          <Text style={paragraph}>
            Unfortunately, after reviewing your application, we regret to inform
            you that your expertise does not align with the specific
            requirements of this project.
          </Text>

          <Text style={paragraph}>
            Please do not be discouraged. We encourage you to keep an eye on
            other opportunities on AsiaDealHub that may better match your skills
            and experience.
          </Text>
          ...
          <Text style={paragraph}>
            Thank you for being a valued member of AsiaDealHub.
          </Text>
        </Section>
