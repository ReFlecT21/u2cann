...
interface AwardExpertTemplateProps {
  greeting: string;
  projectName: string;
}

export const AwardExpertTemplate: React.FC<
  Readonly<AwardExpertTemplateProps>
      ...
      <Container style={container}>
        ...
        <Section style={content}>
          ...
          <Text style={paragraph}>
            Congratulations! You have been awarded the project opportunity on
            AsiaDealHub.
          </Text>
          ...
          <Text style={paragraph}>
            A contract will be sent to you shortly. Please look out for an email
            from us.
          </Text>
