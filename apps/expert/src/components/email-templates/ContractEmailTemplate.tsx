...
export const ContractEmailTemplate: React.FC<
  Readonly<ContractEmailTemplateProps>
> = ({ greeting, projectName, contractLink }) => (
  <Html>
    <Head />
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={content}>
          ...
          <Text style={paragraph}>
            Good news! A contract has been prepared for{" "}
            <strong>{projectName}</strong>.
          </Text>

          <Text style={paragraph}>
            Please review the details of the contract and sign it to confirm
          ...
          <Text style={paragraph}>
            ...
            to your valuable contributions to this project.
          </Text>
        </Section>

        {/* Call to Action */}
        <Section style={ctaContainer}>
          <Button style={ctaButton} href={contractLink}>
            View Contract
          </Button>
        </Section>
