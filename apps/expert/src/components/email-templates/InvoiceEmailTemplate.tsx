...
export const InvoiceEmailTemplate: React.FC<
  Readonly<InvoiceEmailTemplateProps>
> = ({ greeting, projectName, invoiceLink }) => (
  <Html>
    <Head />
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={content}>
          ...
          <Text style={paragraph}>
            Good news! An invoice has been prepared for{" "}
            <strong>{projectName}</strong>.
          </Text>

          <Text style={paragraph}>
            Please review the details of the invoice and proceed with the
            necessary actions.
          </Text>
        ...
        <Section style={ctaContainer}>
          <Button style={ctaButton} href={invoiceLink}>
            View Invoice
          </Button>
        </Section>
