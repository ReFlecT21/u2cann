...
interface CorpEmailApprovalTemplateProps {}

export const CorpEmailApprovalTemplate: React.FC<
  Readonly<CorpEmailApprovalTemplateProps>
> = () => (
  <Html>
    <Head />
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={content}>
          <Text style={paragraph}>
            Thank you for creating a corporate account with AsiaDealHub.
          </Text>
          <Text style={paragraph}>
            Your application has been received and is currently under review.
            Please allow our admin team some time to verify your details.
          </Text>
          <Text style={paragraph}>
            You will receive another email once your corporate account has been
            approved.
          </Text>
        </Section>
