...
import { useIsMobile } from "@adh/ui/hooks/use-mobile";
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "peer-data-[collapsible=offcanvas]:max-w-screen peer-data-[state=collapsed]:max-w-[calc(100vw-var(--sidebar-width-icon))] peer-data-[state=expanded]:max-w-[calc(100vw-var(--sidebar-width))]",
