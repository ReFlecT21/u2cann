...
const editorContainerVariants = cva(
  "[&_.slate-selection-area]:border-brand/25 relative w-full cursor-text select-text overflow-y-auto caret-primary selection:bg-primary/25 focus-visible:outline-none [&_.slate-selection-area]:border [&_.slate-selection-area]:bg-primary/15",
  {
    defaultVariants: {
      variant: "default",
    },
